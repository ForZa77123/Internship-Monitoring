...
export function InternSidebar({ internName }: InternSidebarProps) {
    ...
    <aside className="flex flex-col w-64 min-h-screen bg-card border-r border-border shrink-0">
      ...
      <div className="flex items-center gap-3 p-6 border-b border-border">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Peserta Magang</p>
        </div>
      </div>

      {/* User info */}
      <div className="flex items-center gap-3 px-4 py-4 mx-3 mt-3 rounded-xl bg-secondary">
        <div className="flex items-center justify-center w-9 h-9 rounded-full bg-primary/20 border border-primary/30 shrink-0 text-primary font-bold text-sm">
